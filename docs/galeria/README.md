...
|---|---|---|---|---|
| [API de pedidos serverless (AWS)](../../examples/aws-serverless.json) | spec | 11 | 92 · proporcion_extrema | [draw.io](https://app.diagrams.net/#Uhttps://raw.githubusercontent.com/Leonsang/AdvanceDrawIO/main/docs/galeria/aws-serverless.drawio) |
